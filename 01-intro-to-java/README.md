...
### Други операции с низове
 ...
 [документация](https://docs.oracle.com/en/java/javase/19/docs/api/java.base/java/lang/String.html)
...
- Не е най-добрата практика да се слагат label-и навсякъде -> коди без
---
...
### Стойности по подразбиране на масивите
...
Многомерните масиви не са задължително в правоъгълен вид. Възможно е да бъдат и назъбени!
